...
sites = 'http://blog.sina.com.cn/ http://www.sohu.com/a/ 163.com news.qq.com '  #@param {type: "string"}
num =100
#@markdown ---
...
#       plogging.info.plogging.info("*"*50)
  ...
  #       plogging.info.plogging.info('句子数目为: ',len(items['sentence']))
      logging.info('句子数目为: '+str(items['paragraph_num']))
  #       plogging.info.plogging.info(items)

      if items['paragraph_num']>2:
